...
def rollout(env,
    ...
    if sampler.save_video:
        clip = ImageSequenceClip(sampler.image_list, fps=25)
        clip.write_videofile('/home/kai/mbpo/videos/video%d.mp4' %
                             env._env.env.start_count, fps=25, audio=False)
