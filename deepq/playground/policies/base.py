...
from deepq.playground.utils.misc import Config
from deepq.playground.utils.misc import REPO_ROOT
...
class Policy:
    ...
    def evaluate(self, n_episodes):
        ...
        print("Avg. reward over {} episodes: {:.4f}".format(
    ...
    def save_checkpoint(self, step=None, is_best=False):
        ...
        if is_best:
            ckpt_file = os.path.join(
                self.checkpoint_dir+"/best/", self.model_name)
        else:
