...
ENVIRONMENT_PARAMS = {
    ...
    {
        "v0": {
            # "terminate_if_not_double_support": True,
            ...
            # "goal_type": "moving_goal" #fixed, random_fixed, moving_goal
        },
        ...
        "v1": {  # reach
            ...
            "weight_dic": {
                ...
                # "weight_lx_vel_reward":         0.0/6.0,
                # "weight_ly_vel_reward":         0.0/6.0,
                # "weight_lz_vel_reward":         0.0/6.0,
                # "weight_rx_vel_reward":         0.0/6.0,
                # "weight_ry_vel_reward":         0.0/6.0,
                # "weight_rz_vel_reward":         0.0/6.0,
                # "weight_joint_vel_reward":      0.0/4.0,
                # "weight_joint_torque_reward":   0.0/4.0,
                # Clamp reward
        ...
        "v2": {  # forward locomotion
            ...
            # "joint_imit_tolerance": {'torsoPitch': 6,
            #                         'rightHipRoll': 10, 'rightHipPitch': 35, 'rightKneePitch': 75, 'rightAnklePitch': 20, 'rightAnkleRoll': 2,
            #                         'leftHipRoll':  10, 'leftHipPitch':  35, 'leftKneePitch':  75, 'leftAnklePitch':  20, 'leftAnkleRoll':  2},
        ...
        "v4": {  # follow goal
            ...
            "lock_upper_body": True,
            "target_velocity": [0.5, 0., 0],
            "goal_type": "fixed_behind",  # fixed, random_fixed, moving_goal, None
            "goal_y_range": 0.0,
            "filter_action": False,
            "action_bandwidth": 12,
            "obs_use_yaw": True,
            ...
            "weight_dic": {
                ...
                "weight_contact_penalty":         0.0,

                "imit_joint_pos_reward":          0.4,
                "imit_eef_contact_reward":        0.275,
                "imit_eef_pos_reward":            0.275,
                "imit_eef_orientation_reward":    0.05,
            },
            ...
            "random_spawn": True,
            # "imit_weights": {"imitation": 0.5, "goal": 0.5},
            "imit_weights": {"imitation": 0.7, "goal": 0.3},

            "base_pos_spawn_offset": [-0.5, 0, 0],
            # "base_pos_spawn_offset": None
            # "final_goal_type": "straight",
