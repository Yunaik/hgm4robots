...
def parse_args():
    ...
    parser.add_argument('--checkpoint_path',
                        type=str,
                        default="/home/kai/pc_scp/pc1/ray_mbpo/Valkyrie/defaults/seed:4650_2020-10-28_17-26-31tm52_dwv/checkpoint_1000",
...
def simulate_policy(args):
    ...
    environment_params.update({"kwargs": {"renders": True}})
    evaluation_environment = get_environment_from_params(environment_params)

    # mb = evaluation_environment._env.env.model.body_mass
    # for idx, item in enumerate(mb):
    #     evaluation_environment._env.env.sim.model.body_mass[idx] = item*0.1
